export interface User {
  ...
  email: string;
  avatar?: string;
  role: 'student' | 'professional' | 'coach';
  goals: string[];
  streak: number;
  joinedAt: string;
...
export interface Notification {
  ...
  title: string;
  body: string;
  type: 'result' | 'reminder' | 'achievement' | 'tip';
  read: boolean;
  createdAt: string;
}
...
export const mockUser: User = {
  ...
  role: 'professional',
  goals: ['Technical interview', 'Presentation'],
  streak: 7,
  joinedAt: '2025-12-01',
  ...
  pronunciationIssues: [
    {
      ...
      phoneme: '/w/',
      correctPhoneme: '/v/',
      tip: 'Try touching your upper teeth with your lower lip to produce the /v/ sound.',
      score: 45,
    },
    {
      word: 'developer',
      phoneme: '/w/',
      correctPhoneme: '/v/',
      tip: 'The "v" in developer needs lip-teeth contact. Practice: "ve-ve-ve-developer".',
      score: 52,
    },
    {
      word: 'innovative',
      phoneme: '/w/',
      correctPhoneme: '/v/',
      tip: 'Start with the /v/ sound slowly. Exaggerate the lip-teeth contact at first.',
      score: 40,
    },
  ],
  fluencyMetrics: {
    ...
    idealRange: [130, 160],
    fillerCount: 3,
    fillerExamples: ['"um" at 0:28', '"basically" at 0:35', '"you know" at 0:42'],
    smoothnessIndex: 65,
  },
  grammarErrors: [
    {
      original: 'I am currently looking for a new opportunity where I can, basically, grow',
      corrected: 'I am currently seeking a new opportunity to grow',
      explanation: 'Remove filler words for cleaner phrasing. "Seeking" is more professional than "looking for".',
      type: 'style',
    },
    {
      original: 'contribute to a, you know, innovative team',
      corrected: 'contribute to an innovative team',
      explanation: 'Use "an" before vowel sounds. Remove the filler "you know".',
      type: 'article',
    },
  ],
  toneAnalysis: {
    monotoneIndex: 42,
    suggestions: [
      'Vary your pitch when emphasizing key achievements.',
      'Pause briefly before important points for emphasis.',
      'Try raising your tone slightly at the end of enthusiasm phrases.',
    ],
  },
  actionPlan: [
    {
      title: 'Daily /v/ sound practice',
      description: 'Repeat 10 words starting with "v" — focus on lip-teeth contact.',
      type: 'daily',
      duration: 5,
    },
    {
      title: 'Filler word elimination drill',
      description: 'Record a 1-minute talk and count filler words. Target: 0 fillers.',
      type: 'drill',
      duration: 10,
    },
    {
      title: 'Watch: Reducing Filler Words',
      description: 'Learn proven techniques to replace fillers with confident pauses.',
      type: 'lesson',
      duration: 5,
    },
  ],
...
export const mockNotifications: Notification[] = [
  ...
  { id: 'n4', title: 'Pronunciation Tip', body: 'Try the "mirror technique" — watch your mouth while practicing /v/ sounds. Your brain builds muscle memory faster.', type: 'tip', read: true, createdAt: '2026-03-05T16:00:00' },
...
export const mockScenarios: Scenario[] = [
  {
    ...
    category: 'HR',
    description: 'Practice the most common interview opener. Structure your response using the Present-Past-Future formula.',
    questions: [
    ...
    tips: [
      ...
      'Start with your current role, then key past experience, then future goals.',
      'Try to include 2 technical examples and 1 leadership example.',
    ],
  },
  {
    id: 's2',
    ...
    category: 'Technical',
    description: 'Practice explaining a system design with clear structure and technical vocabulary.',
    questions: [
      'Design a URL shortener system.',
      'How would you design a ride-sharing app?',
      'Explain the architecture of a chat application.',
    ],
    tips: [
      'Start with clarifying requirements.',
      'Use specific numbers for scale estimates.',
      'Mention trade-offs for each design decision.',
    ],
  },
  {
    id: 's3',
    ...
    category: 'Managerial',
    description: 'Practice describing how you handle team conflicts using the STAR method.',
    questions: [
      'Tell me about a time you disagreed with a colleague.',
      'How do you handle conflicts in the team?',
      'Describe a challenging team situation you resolved.',
    ],
    tips: [
      'Use the STAR method: Situation, Task, Action, Result.',
      'Focus on the resolution and what you learned.',
      'Show empathy and leadership qualities.',
    ],
  },
];
...
export const mockMentors: Mentor[] = [
  {
    ...
    description: 'Expert in behavioral interviews and interpersonal dynamics.',
    avatar: '/mentors/sarah.jpg',
    personality: 'Professional, empathetic, and detail-oriented.',
    expertise: ['HR Interviews', 'Soft Skills', 'Conflict Resolution'],
  },
  {
    id: 'm2',
    name: 'David',
    role: 'Tech Lead at Google',
    description: 'Specializes in technical architecture and engineering leadership.',
    avatar: '/mentors/david.jpg',
    personality: 'Logical, direct, and growth-oriented.',
    expertise: ['Technical Design', 'System Design', 'Code Reviews'],
  },
  {
    id: 'm3',
    name: 'Aisha',
    role: 'Executive Coach',
    description: 'Helps leaders build presence and strategic communication.',
    avatar: '/mentors/aisha.jpg',
    personality: 'Inspirational, calm, and visionary.',
    expertise: ['Public Speaking', 'Executive Presence', 'Negotiation'],
  },
];
...
export const mockPracticePrompts = [
